...
GEN_KWARGS="temperature=0.0,presence_penalty=0.0,repetition_penalty=1.0" run_lighteval_suite "baseline" auto
GEN_KWARGS="temperature=0.0,presence_penalty=0.0,repetition_penalty=1.0" run_lighteval_suite "vanilla" auto steps=5 topk=3 draft=15
