...
CSD_REBUILD_TOP_KEEP=${CSD_REBUILD_TOP_KEEP:-20000}
...
run_method_set() {
  ...
  local max_length="$6"
  local methods=(vanilla csd_plain_table_static csd_plain_table csd_plain_table_top5)
  # local methods=(csd_plain_table_top5 csd_ratio_table_top5 vanilla csd_plain_table_static csd_ratio_table_static)
  # local methods=(csd_plain_table_top5 csd_plain_table_static)
  local method status
