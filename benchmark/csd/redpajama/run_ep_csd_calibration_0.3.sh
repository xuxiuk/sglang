...
MODEL_PATH=${MODEL_PATH:-/root/model/Qwen3.5-397B-A17B-FP8}
...
CSD_RECORD_IGNORE_PROB_RATIO=${CSD_RECORD_IGNORE_PROB_RATIO:-0}
...
CSD_TABLE_PATH=${CSD_TABLE_PATH:-"${OUT_DIR}/csd_table_redpajama_${CSD_TABLE_KIND}_6domains_n${SAMPLES_PER_DOMAIN}_${MODEL_NAME_PART}_${DRAFT_MODEL_NAME_PART}_${SPEC_ALGORITHM_PART}_${SPEC_SHAPE_PART}_temp${TEMPERATURE}_ratio${CSD_PROB_RATIO}.json"}
