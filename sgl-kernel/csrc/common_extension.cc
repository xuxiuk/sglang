...
TORCH_LIBRARY_FRAGMENT(sgl_kernel, m) {
  ...
  m.def(
      ...
      "Tensor csd_delta_float_stats, Tensor csd_delta_int_stats, Tensor csd_debug_event_pairs, "
      "Tensor csd_debug_event_float_stats, Tensor csd_debug_event_int_stats, Tensor csd_debug_event_counter, "
      "int csd_debug_event_capacity, int csd_debug_sample_rate, bool csd_debug_stats_enabled, "
